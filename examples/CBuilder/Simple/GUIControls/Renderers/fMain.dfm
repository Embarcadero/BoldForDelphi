object Form1: TForm1
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object lblSalaryBreakPoint: TLabel
    Left = 216
    Top = 244
    Width = 87
    Height = 13
    Caption = 'Salary BreakPoint:'
  end
  object BoldGrid1: TBoldGrid
    ...
    Columns = <
      ...
      item
        BoldProperties.Renderer = bsrFullName
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      item
        ...
        BoldProperties.Renderer = bsrSalaryLevel
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
  ...
  object btxtBreakPoint: TBoldEdit
    Left = 312
    Top = 240
    Width = 121
    Height = 21
    BoldHandle = blhGlobals
    BoldProperties.Expression = 'salaryBreakPoint'
  ...
  object bsrFullName: TBoldAsStringRenderer
    OnMayModify = bsrFullNameMayModify
    OnSubscribe = bsrFullNameSubscribe
    OnGetAsString = bsrFullNameGetAsString
    OnSetAsString = bsrFullNameSetAsString
    Left = 280
    Top = 32
  end
  object bsrSalaryLevel: TBoldAsStringRenderer
    OnSubscribe = bsrSalaryLevelSubscribe
    OnSetColor = bsrSalaryLevelSetColor
    Left = 392
    Top = 32
  end
  object blhGlobals: TBoldListHandle
    RootHandle = BoldSystemHandle1
    Expression = 'Globals.allInstances'
    Left = 360
    Top = 236
  end
