...
void __fastcall TSQLHandleClassesRootList::Add(TSQLHandleClassesRoot *NewObject)
{
  if (NewObject != NULL)
  {
...
int __fastcall TSQLHandleClassesRootList::IndexOf(TSQLHandleClassesRoot *anObject)
{
  int result = IndexOfElement(anObject);
  return result;
}

int __fastcall TSQLHandleClassesRootList::Includes(TSQLHandleClassesRoot *anObject) // boolean?
{
  int result = IncludesElement(anObject);
  return result;
}

TSQLHandleClassesRoot* __fastcall TSQLHandleClassesRootList::AddNew()
{
  TSQLHandleClassesRoot *result = dynamic_cast<TSQLHandleClassesRoot*>(InternalAddNew());
  return result;
}

void __fastcall TSQLHandleClassesRootList::Insert(int index, TSQLHandleClassesRoot *NewObject)
{
  if (NewObject != NULL)
  {
...
TSQLHandleClassesRoot* __fastcall TSQLHandleClassesRootList::GetBoldObject(int index)
{
  TSQLHandleClassesRoot *result = dynamic_cast<TSQLHandleClassesRoot*>(GetElement(index));
  return result;
}

void __fastcall TSQLHandleClassesRootList::SetBoldObject(int index, TSQLHandleClassesRoot *NewObject)
{
...
{
  BoldObjectListClasses->AddObjectEntry("SQLHandleClassesRoot", __classid(TSQLHandleClassesRootList));
...
{
  BoldObjectClasses->AddObjectEntry("SQLHandleClassesRoot", __classid(TSQLHandleClassesRoot));
...
TBoldGeneratedCodeDescriptor *CodeDescriptor = GeneratedCodes()->AddGeneratedCodeDescriptorWithFunc("SQLHandleClasses", &InstallBusinessClasses, &InstallObjectListClasses, GeneratedCodeCRC());
