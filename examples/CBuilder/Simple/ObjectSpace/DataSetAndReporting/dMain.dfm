object dmMain: TdmMain
  ...
  object BoldModel1: TBoldModel
    ...
    Model = (
      ...
      #9'""'
        ...
        'hiName=<Name>,Bold.RootClass=BusinessClassesRoot"'
      #9'(Classes'
      #9#9'(Class'
      #9#9#9'"BusinessClassesRoot"'
      #9#9#9'"<NONE>"'
  ...
  object bphBDMain: TBoldPersistenceHandleDB
    BoldModel = bmoMain
    ClockLogGranularity = '0:0:0.0'
    DatabaseAdapter = bdbaMain
    Left = 248
    Top = 8
  end
  object bdbaMain: TBoldDatabaseAdapterIB
