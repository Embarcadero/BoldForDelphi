object frmMain: TfrmMain
  ...
  Width = 607
  Height = 578
  Caption = 'Object Versioning Example'
  Color = clBtnFace
  ...
  object behCurrentUser: TBoldExpressionHandle
    StaticSystemHandle = dmModel.BoldSystemHandle1
    RootHandle = dmModel.BoldSystemHandle1
    Expression = 'PersContext.allInstances->first.currentUser'
    Left = 104
    Top = 64
  end
  ...
  object bvdPartVersions: TBoldVariableDefinition
    Variables = <
      item
  ...
  object BoldVariableDefinition1: TBoldVariableDefinition
    Variables = <
      item
  ...
  object behDisplayDoc: TBoldExpressionHandle
    ...
    Variables = BoldVariableDefinition1
    Left = 344
    Top = 248
  end
  ...
  object ActionList1: TActionList
    ...
    object BoldActivateSystemAction1: TBoldActivateSystemAction
      ...
      Caption = 'Open system'
      BoldSystemHandle = dmModel.BoldSystemHandle1
