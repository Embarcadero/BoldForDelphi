  ...
  object BoldModel1: TBoldModel
    ...
    Model = (
      ...
      #9'""'
        ...
        'rnal.toolId=38FC6F1E028B,Bold.DelphiName=<Name>,Bold.RootClass=D' +
        'ocumentClassesRoot,Bold.UnitName=DocumentClasses"'
      #9'(Classes'
      #9#9'(Class'
      ...
      #9#9#9#9#9'""'
        ...
        '=transient,\"Bold.DerivationOCL=if author.persContext->isEmpty t' +
        'hen lastPublished else timestampNow endif\""'
      #9#9#9#9')'
      #9#9#9#9'(Attribute'
      #9#9#9#9#9'"Title"'
      #9#9#9#9#9'"string"'
      ...
      #9#9#9'""'
      #9#9#9'""'
      #9#9#9'"_BoldInternal.toolId=38FD5BF902F8,persistence=persistent"'
      #9#9#9'(Attributes'
      #9#9#9')'
      #9#9#9'(Methods'
      #9#9#9')'
      ...
      #9#9#9'""'
        ...
        #9#9#9'"_Boldify.autoCreated=True,persistence=persistent,Bold.Versio' +
        'ned=True"'
      #9#9#9'(Attributes'
      #9#9#9')'
      #9#9#9'(Methods'
      ...
      #9#9#9#9#9'0'
        ...
        #9#9#9#9#9'"_BoldInternal.toolId=38FC78D000F0,Bold.DerivationOCL=conta' +
        'ins.atTime(viewVersion)->select(existing),Bold.Embed=False"'
      #9#9#9#9#9'(Qualifiers'
      #9#9#9#9#9')'
      #9#9#9#9')'
      #9#9#9#9'(Role'
      #9#9#9#9#9'"x_ViewContains_Project"'
      #9#9#9#9#9'FALSE'
      #9#9#9#9#9'FALSE'
      #9#9#9#9#9'"Document"'
      #9#9#9#9#9'""'
      ...
      #9#9#9#9#9'0'
        ...
        'ldify.wasEmbeded=True,_BoldInternal.toolId=38FC78D000F1,Bold.Emb' +
        'ed=False"'
      #9#9#9#9#9'(Qualifiers'
      #9#9#9#9#9')'
      #9#9#9#9')'
      ...
      #9#9#9#9#9'0'
        ...
        'd.Embed=False,Bold.Ordered=True"'
      #9#9#9#9#9'(Qualifiers'
      #9#9#9#9#9')'
      #9#9#9#9')'
      #9#9#9')'
