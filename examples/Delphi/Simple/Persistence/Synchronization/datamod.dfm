object DataModule1: TDataModule1
  ...
  object BoldModel1: TBoldModel
    ...
    Model = (
      ...
      #9'""'
        ...
        'ImplementationUses=dialogs,Bold.UnitName=<Name>,Bold.RootClass=B' +
        'usinessClassesRoot"'
      #9'(Classes'
      #9#9'(Class'
      ...
      #9#9#9'""'
        ...
        #9#9#9'"persistence=Persistent,Bold.TableName=<Prefix>_OBJECT,Bold.P' +
        'Mapper=<default>,Bold.Versioned=<Default>"'
      #9#9#9'(Attributes'
      #9#9#9')'
      #9#9#9'(Methods'
      #9#9#9')'
      ...
      #9#9#9'""'
        ...
        #9#9#9'"persistence=Persistent,Bold.FileName=Building.inc,Bold.Versi' +
        'oned=<Default>"'
      #9#9#9'(Attributes'
      #9#9#9#9'(Attribute'
      #9#9#9#9#9'"ZipCode"'
      ...
      #9#9#9'""'
        ...
        #9#9#9'"persistence=Persistent,Bold.TableName=Ownership,Bold.PMapper' +
        '=<default>,Bold.Versioned=<Default>"'
      #9#9#9'(Attributes'
      #9#9#9')'
      #9#9#9'(Methods'
      #9#9#9')'
      ...
      #9#9#9'""'
        ...
        #9#9#9'"persistence=Persistent,Bold.FileName=Person.inc,Bold.Version' +
        'ed=<Default>"'
      #9#9#9'(Attributes'
      #9#9#9#9'(Attribute'
      #9#9#9#9#9'"FirstName"'
      ...
      #9#9#9'""'
        ...
        #9#9#9'"persistence=Persistent,Bold.FileName=ResidentialBuilding.inc' +
  ...
  object BoldUMLRoseLink1: TBoldUMLRoseLink
    FileName = 
      'D:\kala\Bold\BfD\Examples\Compound examples\building\Building.md' +
      'l'
    Tools.Strings = (
      'DDL'
      'Bold')
  ...
  object BoldExternalObjectSpaceEventHandler1: TBoldExternalObjectSpaceEventHandler
    ...
    OnDoDisconnect = BoldExternalObjectSpaceEventHandler1DoDisconnect
    Left = 492
    Top = 148
  end
  object BoldPropagatorHandleCOM1: TBoldPropagatorHandleCOM
    ...
    OnPropagatorCallFailed = BoldPropagatorHandleCOM1PropagatorCallFailed
    Left = 416
    Top = 264
  end
